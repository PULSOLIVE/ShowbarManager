...
public class CreateInternationalizationRequest {
    ...
    @NotBlank(message = "O nome amigável do fuso horário é obrigatório.")
    @Size(max = 120, message = "O nome amigável do fuso horário deve ter no máximo 120 caracteres.")
    private String timezoneLabel;

    @Size(max = 30, message = "O formato de data deve ter no máximo 30 caracteres.")
    private String dateFormat = "dd/MM/yyyy";

    @Size(max = 20, message = "O formato de hora deve ter no máximo 20 caracteres.")
    private String timeFormat = "HH:mm";

    @Size(max = 10, message = "A bandeira em emoji deve ter no máximo 10 caracteres.")
